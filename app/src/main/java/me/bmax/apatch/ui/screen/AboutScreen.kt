...
private val DarkGradientPalettes = listOf(
    listOf(Color(0.02f, 0.10f, 0.35f, 0.32f), Color(0.05f, 0.22f, 0.48f, 0.36f), Color(0.18f, 0.08f, 0.42f, 0.30f), Color(0.04f, 0.14f, 0.40f, 0.34f)),
    listOf(Color(0.03f, 0.16f, 0.44f, 0.33f), Color(0.22f, 0.07f, 0.38f, 0.31f), Color(0.01f, 0.18f, 0.42f, 0.35f), Color(0.02f, 0.11f, 0.36f, 0.30f)),
    listOf(Color(0.20f, 0.09f, 0.36f, 0.30f), Color(0.06f, 0.12f, 0.38f, 0.34f), Color(0.24f, 0.10f, 0.34f, 0.32f), Color(0.03f, 0.09f, 0.32f, 0.36f)),
)
